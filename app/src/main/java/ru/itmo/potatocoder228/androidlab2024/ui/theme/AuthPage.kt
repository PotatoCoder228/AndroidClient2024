...
@Composable
fun LoginField(modifier: Modifier, placeholder: String = "Login") {
...
@Composable
fun PasswordField(modifier: Modifier, placeholder: String = "Password") {
    var text by remember() {
        mutableStateOf("")
    }
    Row(modifier) {
...
@OptIn(DelicateCoroutinesApi::class)
@Composable
fun SignUpButton(modifier: Modifier, placeholder: String = "Sign Up") {
